...
export const PAGE_META = {
  '/': {
    title: 'Arkaserve Tools -- Free PDF Tools, Document & Code Converters Online',
  ...
  '/merge-pdf': {
    title: 'Merge PDF Online Free -- Combine PDF Files into One | Arkaserve Tools',
  ...
  '/split-pdf': {
    title: 'Split PDF Online Free -- Extract & Separate PDF Pages | Arkaserve Tools',
  ...
  '/compress-pdf': {
    title: 'Compress PDF Online Free -- Reduce PDF File Size | Arkaserve Tools',
  ...
  '/pdf-to-word': {
    title: 'PDF to Word Converter Free -- Convert PDF to DOC, DOCX Online | Arkaserve Tools',
  ...
  '/word-to-pdf': {
    title: 'Word to PDF Converter Free -- Convert DOCX & DOC to PDF Online | Arkaserve Tools',
  ...
  '/pdf-to-jpg': {
    title: 'PDF to JPG Converter Free -- Convert PDF to Image Online | Arkaserve Tools',
  ...
  '/jpg-to-pdf': {
    title: 'JPG to PDF Converter Free -- Convert Images to PDF Online | Arkaserve Tools',
  ...
  '/rotate-pdf': {
    title: 'Rotate PDF Pages Online Free -- Fix PDF Orientation | Arkaserve Tools',
  ...
  '/watermark-pdf': {
    title: 'Add Watermark to PDF Online Free -- Text Watermark | Arkaserve Tools',
  ...
  '/protect-pdf': {
    title: 'Password Protect PDF Online Free -- Lock PDF | Arkaserve Tools',
  ...
  '/excel-to-pdf': {
    title: 'Excel to PDF Converter Free -- Convert XLSX to PDF Online | Arkaserve Tools',
  ...
  '/pdf-to-excel': {
    title: 'PDF to Excel Converter Free -- Extract Tables to XLSX | Arkaserve Tools',
  ...
  '/html-to-pdf': {
    title: 'HTML to PDF Converter Free -- Convert HTML Code to PDF | Arkaserve Tools',
  ...
  '/pptx-to-pdf': {
    title: 'PowerPoint to PDF Converter Free -- PPTX to PDF Online | Arkaserve Tools',
  ...
  '/analyze-pdf': {
    title: 'PDF Analyzer Online Free -- Inspect PDF Properties | Arkaserve Tools',
  ...
  '/json-beautifier': {
    title: 'JSON Beautifier & Formatter Online Free -- Pretty Print JSON | Arkaserve Tools',
  ...
  '/json-validator': {
    title: 'JSON Validator Online Free -- Validate & Check JSON Syntax | Arkaserve Tools',
  ...
  '/sql-formatter': {
    title: 'SQL Formatter & Beautifier Online Free -- Format SQL Queries | Arkaserve Tools',
  ...
  '/jwt-debugger': {
    title: 'JWT Debugger & Decoder Online Free -- Decode JWT Token | Arkaserve Tools',
  ...
  '/qr-generator': {
    title: 'QR Code Generator Online Free -- Create & Download QR Codes | Arkaserve Tools',
  ...
  '/regex-tester': {
    title: 'Regex Tester Online Free -- Test Regular Expressions | Arkaserve Tools',
  ...
  '/hash-generator': {
    title: 'Hash Generator Online Free -- MD5, SHA-256, SHA-512 Checksum | Arkaserve Tools',
  ...
  '/webp-converter': {
    title: 'WebP Converter Online Free -- Convert WebP to JPG, PNG & More | Arkaserve Tools',
  ...
  '/image-compressor': {
    title: 'Image Compressor Online Free -- Reduce Image File Size | Arkaserve Tools',
  ...
  '/heic-converter': {
    title: 'HEIC to JPG Converter Online Free -- Convert iPhone Photos | Arkaserve Tools',
  ...
  '/bg-remover': {
    title: 'Background Remover Online Free -- Remove Image Background with AI | Arkaserve Tools',
  ...
  '/color-converter': {
    title: 'Color Converter Online Free -- HEX, RGB, HSL, HSV, CMYK | Arkaserve Tools',
  ...
  '/word-compare': {
    title: 'Text Diff Tool Online Free -- Compare Two Texts Side by Side | Arkaserve Tools',
  ...
  '/word-count': {
    title: 'Word Count Tool Online Free -- Count Words, Characters & More | Arkaserve Tools',
  ...
  '/code-diff': {
    title: 'Code Diff Viewer Online Free -- Compare Code Changes | Arkaserve Tools',
  ...
  '/css-js-minifier': {
    title: 'CSS & JS Minifier Online Free -- Minify CSS and JavaScript | Arkaserve Tools',
  ...
  '/markdown-preview': {
    title: 'Markdown Preview & Editor Online Free -- Live Markdown Renderer | Arkaserve Tools',
  ...
  '/unit-converter': {
    title: 'Unit Converter Online Free -- Length, Weight, Temperature & More | Arkaserve Tools',
  ...
  '/timezone-converter': {
    title: 'Timezone Converter Online Free -- World Time Zone Clock | Arkaserve Tools',
  ...
  '/url-encode': {
    title: 'URL Encoder & Decoder Online Free -- Percent Encode URLs | Arkaserve Tools',
  ...
  '/favicon-generator': {
    title: 'Favicon Generator Online Free -- Create Favicon from Image | Arkaserve Tools',
    ...
    steps: [
      ...
      'Preview the favicon at different sizes (16Ã—16, 32Ã—32, 64Ã—64, 180Ã—180 px) - crop or center as needed.',
  ...
  '/color-palette': {
    title: 'Color Palette Extractor Online Free -- Extract Colors from Image | Arkaserve Tools',
  ...
  '/css-gradient': {
    title: 'CSS Gradient Generator Online Free -- Create CSS Gradients | Arkaserve Tools',
  ...
  '/svg-converter': {
    title: 'SVG to PNG Converter Online Free -- Convert SVG to Image | Arkaserve Tools',
    ...
    steps: [
      ...
      'Set the output resolution (width Ã— height in pixels) - the default maintains the SVG\'s aspect ratio.',
  ...
  '/image-cropper': {
    title: 'Image Cropper Online Free -- Crop Images to Any Size | Arkaserve Tools',
  ...
  '/image-resizer': {
    title: 'Image Resizer Online Free -- Resize Images to Exact Size | Arkaserve Tools',
  ...
  '/image-metadata': {
    title: 'EXIF Metadata Remover Online Free -- Strip Image Metadata | Arkaserve Tools',
  ...
  '/yaml-json': {
    title: 'YAML to JSON Converter Free -- Convert YAML & JSON Online | Arkaserve Tools',
  ...
  '/xml-formatter': {
    title: 'XML Formatter Online Free -- Format & Validate XML | Arkaserve Tools',
  ...
  '/html-tools': {
    title: 'HTML Tools Online Free -- Encode, Decode & Format HTML | Arkaserve Tools',
  ...
  '/cron-descriptor': {
    title: 'Cron Expression Descriptor Online Free -- Explain Cron Jobs | Arkaserve Tools',
  ...
  '/number-base': {
    title: 'Number Base Converter Online Free -- Binary, Decimal, Hex | Arkaserve Tools',
  ...
  '/unicode-inspector': {
    title: 'Unicode Inspector Online Free -- Inspect Unicode Characters | Arkaserve Tools',
    ...
    faqs: [
      ...
      { q: 'What is a Unicode code point?', a: 'A Unicode code point is a unique number assigned to every character - written as U+XXXX (hex). For example, A is U+0041, the heart emoji â¤ is U+2764.' },
  ...
  '/ip-calculator': {
    title: 'IP Calculator Online Free -- Subnet & CIDR Calculator | Arkaserve Tools',
  ...
  '/lorem-ipsum': {
    title: 'Lorem Ipsum Generator Online Free -- Placeholder Text | Arkaserve Tools',
  ...
  '/heic-converter': {
    title: 'HEIC to JPG Converter Online Free -- Convert iPhone Photos Instantly | Arkaserve Tools',
  ...
  '/protect-pdf': {
    title: 'Password Protect PDF Online Free -- Lock & Encrypt PDF | Arkaserve Tools',
  ...
  '/about': {
    title: 'About Arkaserve Tools -- Free Online PDF & Document Tools by Arkaserve',
  ...
  '/contact': {
    title: 'Contact Arkaserve Tools -- Get in Touch | Arkaserve Tools',
  ...
  '/privacy-policy': {
    title: 'Privacy Policy -- Arkaserve Tools by Arkaserve',
