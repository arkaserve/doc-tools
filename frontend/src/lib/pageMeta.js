export const SITE = 'Arkaserve Tools'
export const BASE_URL = 'https://tools.arkaserve.com'
export const DEFAULT_DESC = 'Free online tools for PDF, Word, Excel, JSON, images and more. Convert, merge, split, compress â€” 100% free, no signup needed.'
export const DEFAULT_KEYWORDS = 'free online tools, PDF tools, document converter, image tools, developer tools, Arkaserve Tools'

export const PAGE_META = {
  '/': {
    title: 'Arkaserve Tools â€“ Free PDF Tools, Document & Code Converters Online',
    ...
    keywords: 'free PDF tools online, free PDF tools no signup, free PDF tools without watermark, merge PDF free, split PDF free, compress PDF free, PDF to Word free, Word to PDF free, PDF converter free no email, document tools online free, image converter online free, JSON formatter free, SQL formatter free, free online tools for students, free tools for office work, Arkaserve Tools, best free PDF tools 2026, free PDF tools India, online tools no registration, all in one free tools online',
  },
  '/merge-pdf': {
    title: 'Merge PDF Online Free â€“ Combine PDF Files into One | Arkaserve Tools',
    ...
    steps: [
      'Click "Upload Files" or drag and drop your PDF files onto the page â€” you can add up to 20 PDFs at once.',
    ...
    faqs: [
      { q: 'Is merging PDF files free?', a: 'Yes, 100% free â€” no account, no subscription, no watermark added to your file. You can merge unlimited PDFs for free on Arkaserve Tools.' },
  ...
  '/split-pdf': {
    title: 'Split PDF Online Free â€“ Extract & Separate PDF Pages | Arkaserve Tools',
  ...
  '/compress-pdf': {
    title: 'Compress PDF Online Free â€“ Reduce PDF File Size | Arkaserve Tools',
    ...
    steps: [
      ...
      'Click "Compress PDF" and download your smaller PDF file instantly â€” completely free.',
    ],
    faqs: [
      ...
      { q: 'How much can I reduce a PDF file size?', a: 'Depending on the content, you can typically reduce PDF size by 40â€“80%. PDFs with many images compress much more than text-only documents.' },
  ...
  '/pdf-to-word': {
    title: 'PDF to Word Converter Free â€“ Convert PDF to DOC, DOCX Online | Arkaserve Tools',
    desc: 'Convert PDF to editable Word document (DOC or DOCX) online for free. No signup, no watermark, no email required â€” instant download. Works on mobile, iPhone, Android, and all browsers.',
    ...
    steps: [
      ...
      'Click Download to save your editable .docx file â€” no signup, completely free.',
    ],
    faqs: [
  ...
  '/word-to-pdf': {
    title: 'Word to PDF Converter Free â€“ Convert DOCX & DOC to PDF Online | Arkaserve Tools',
    desc: 'Convert Word documents (DOC or DOCX) to PDF online for free. No email, no signup, no watermark â€” just upload and convert. Works on mobile, iPhone, Android, and all browsers.',
    ...
    steps: [
      ...
      'Download your PDF file instantly â€” no signup, no watermark, completely free.',
    ],
    faqs: [
  ...
  '/pdf-to-jpg': {
    title: 'PDF to JPG Converter Free â€“ Convert PDF to Image Online | Arkaserve Tools',
  ...
  '/jpg-to-pdf': {
    title: 'JPG to PDF Converter Free â€“ Convert Images to PDF Online | Arkaserve Tools',
    ...
    steps: [
      ...
      'Click "Convert to PDF" and download your PDF document instantly â€” no signup needed.',
    ],
    faqs: [
  ...
  '/rotate-pdf': {
    title: 'Rotate PDF Pages Online Free â€“ Fix PDF Orientation | Arkaserve Tools',
    desc: 'Fix sideways or upside-down PDF pages online for free. Rotate individual pages or the entire PDF by 90Â°, 180Â°, or 270Â° and save permanently.',
    ...
    steps: [
      'Upload your PDF file by clicking the button or dragging it onto the page.',
      'Select which pages to rotate (all pages or specific pages) and choose the rotation angle: 90Â°, 180Â°, or 270Â°.',
    ...
    faqs: [
      ...
      { q: 'What rotation angles are supported?', a: '90Â° clockwise, 180Â° (upside down), and 270Â° clockwise (or 90Â° counter-clockwise) are all supported.' },
    ],
  },
  '/watermark-pdf': {
    title: 'Add Watermark to PDF Online Free â€“ Text Watermark | Arkaserve Tools',
    ...
    steps: [
      ...
      'Click "Add Watermark" and download your watermarked PDF instantly â€” no signup required.',
    ],
    faqs: [
      { q: 'Is adding a watermark to PDF free?', a: 'Yes, completely free. No account needed and no extra watermark is added by Arkaserve itself.' },
      { q: 'Can I control where the watermark appears?', a: 'Yes. You can set the watermark position (center, diagonal, top, bottom), opacity (10%â€“100%), font size, and color.' },
  ...
  '/protect-pdf': {
    title: 'Password Protect PDF Online Free â€“ Lock PDF | Arkaserve Tools',
    desc: 'Add password protection to your PDF file online for free. Lock your document so only authorized people can open it. AES-128 encryption â€” no signup needed.',
  ...
  '/excel-to-pdf': {
    title: 'Excel to PDF Converter Free â€“ Convert XLSX to PDF Online | Arkaserve Tools',
    ...
    steps: [
      ...
      'Download your PDF document instantly â€” no signup or account required.',
    ],
    faqs: [
  ...
  '/pdf-to-excel': {
    title: 'PDF to Excel Converter Free â€“ Extract Tables to XLSX | Arkaserve Tools',
    ...
    steps: [
      ...
      'Download the editable Excel spreadsheet (.xlsx) file â€” open it directly in Microsoft Excel or Google Sheets.',
    ],
    faqs: [
  ...
  '/html-to-pdf': {
    title: 'HTML to PDF Converter Free â€“ Convert HTML Code to PDF | Arkaserve Tools',
    ...
    steps: [
      ...
      'Preview how it renders in the browser before converting â€” styles and scripts are applied.',
      'Click "Convert to PDF" and download the styled PDF document â€” no signup required.',
    ],
    faqs: [
      ...
      { q: 'Can I convert a full webpage URL to PDF?', a: 'This tool is for pasting HTML code directly. For URL-based webpage capture, consider using your browser\'s built-in Print â†’ Save as PDF feature.' },
    ],
  },
  '/pdf-to-pptx': {
    title: 'PDF to PowerPoint Converter Free â€“ PDF to PPTX Online | Arkaserve Tools',
  ...
  '/pptx-to-pdf': {
    title: 'PowerPoint to PDF Converter Free â€“ PPTX to PDF Online | Arkaserve Tools',
    ...
    steps: [
      ...
      'Download the PDF document instantly â€” no signup, no watermark, completely free.',
    ],
    faqs: [
  ...
  '/analyze-pdf': {
    title: 'PDF Analyzer Online Free â€“ Inspect PDF Properties | Arkaserve Tools',
    desc: 'Analyze any PDF online for free â€” detect document type (invoice, resume, contract), check page count, metadata, fonts, and conversion quality. Instant PDF inspector.',
    ...
    steps: [
      ...
      'Review the detailed analysis report instantly â€” no signup required.',
    ],
    faqs: [
  ...
  '/json-beautifier': {
    title: 'JSON Beautifier & Formatter Online Free â€“ Pretty Print JSON | Arkaserve Tools',
    ...
    steps: [
      'Paste your JSON string into the input area on the left â€” even minified single-line JSON works.',
    ...
    faqs: [
      ...
      { q: 'Can I use it to minify JSON too?', a: 'Yes. Click the "Minify" option to compact your JSON to a single line â€” useful for production APIs and configuration files.' },
    ],
  },
  '/json-validator': {
    title: 'JSON Validator Online Free â€“ Validate & Check JSON Syntax | Arkaserve Tools',
    ...
    steps: [
      ...
      'The validator instantly checks the syntax â€” valid JSON shows a green confirmation, errors show the exact line and character.',
  ...
  '/xml-beautifier': {
    title: 'XML Beautifier & Formatter Online Free | Arkaserve Tools',
    ...
    steps: [
      'Paste your XML string into the input area â€” raw, minified, or badly formatted XML all work.',
  ...
  '/sql-formatter': {
    title: 'SQL Formatter & Beautifier Online Free â€“ Format SQL Queries | Arkaserve Tools',
    ...
    faqs: [
      ...
      { q: 'Will formatting change my SQL logic?', a: 'No. The formatter only changes whitespace and indentation â€” it never alters the logic, keywords, or values in your query.' },
    ],
  },
  '/jwt-debugger': {
    title: 'JWT Debugger & Decoder Online Free â€“ Decode JWT Token | Arkaserve Tools',
    ...
    steps: [
      ...
      'Inspect your claims â€” check if the token is expired or review any custom payload fields.',
    ],
    faqs: [
      { q: 'Is the JWT debugger free?', a: 'Yes, 100% free with no signup required.' },
      { q: 'Is it safe to paste my JWT token here?', a: 'JWT decoding is a purely local browser operation â€” your token is NOT sent to any server. It is decoded entirely in your browser using JavaScript.' },
  ...
  '/qr-generator': {
    title: 'QR Code Generator Online Free â€“ Create & Download QR Codes | Arkaserve Tools',
    ...
    steps: [
      ...
      'Enter your content â€” the QR code preview updates in real time as you type.',
    ...
    faqs: [
      ...
      { q: 'Can I use the generated QR code for commercial purposes?', a: 'Yes. QR codes generated here are yours to use freely â€” for products, marketing, business cards, or any other purpose.' },
      ...
      { q: 'What resolution is the downloaded QR code?', a: 'The downloaded PNG is high resolution (at least 512Ã—512 px), suitable for printing on business cards, posters, and product labels.' },
    ],
  },
  '/regex-tester': {
    title: 'Regex Tester Online Free â€“ Test Regular Expressions | Arkaserve Tools',
    ...
    steps: [
      ...
      'Paste your test string in the text area below â€” all matches are highlighted in real time.',
  ...
  '/hash-generator': {
    title: 'Hash Generator Online Free â€“ MD5, SHA-256, SHA-512 Checksum | Arkaserve Tools',
    ...
    steps: [
      ...
      'Copy the generated hash value from the output â€” the hash updates instantly as you type.',
    ],
    faqs: [
      ...
      { q: 'Is hashing done in my browser or on a server?', a: 'Hashing is done entirely in your browser using the Web Crypto API. Your text is never sent to any server â€” it is completely private.' },
  ...
  '/webp-converter': {
    title: 'WebP Converter Online Free â€“ Convert WebP to JPG, PNG & More | Arkaserve Tools',
    desc: 'Convert WebP images to JPG or PNG, or convert JPG/PNG images to WebP format for faster web pages. Free online WebP converter â€” no signup needed.',
    ...
    steps: [
      ...
      'Download the converted image instantly â€” no signup, no watermark.',
    ],
    faqs: [
      { q: 'Is the WebP converter free?', a: 'Yes, 100% free with no account required.' },
      { q: 'Why should I convert images to WebP?', a: 'WebP images are typically 25â€“35% smaller than JPG and PNG at the same quality, which makes websites load faster and improves Core Web Vitals scores.' },
  ...
  '/image-compressor': {
    title: 'Image Compressor Online Free â€“ Reduce Image File Size | Arkaserve Tools',
    desc: 'Compress JPEG, PNG, and WebP images online for free. No signup, no watermark, no cloud upload â€” works in your browser. Reduce image size for websites, email, and WhatsApp instantly.',
    ...
    steps: [
      ...
      'Drag the quality slider to balance between file size and image sharpness â€” see the live before/after size comparison.',
      'Download the compressed image â€” no signup, no watermark, completely free.',
    ],
    faqs: [
      { q: 'Is the image compressor free?', a: 'Yes, 100% free. No account needed, compress unlimited images.' },
      { q: 'Will compression make my images look blurry?', a: 'At 70â€“85% quality, the difference is barely noticeable to the human eye while achieving 50â€“70% file size reduction.' },
      { q: 'Is image compression done in my browser?', a: 'Yes. Compression happens entirely in your browser using Canvas API. Your images are never uploaded to any server â€” complete privacy.' },
  ...
  '/heic-converter': {
    title: 'HEIC to JPG Converter Online Free â€“ Convert iPhone Photos | Arkaserve Tools',
    desc: 'Convert iPhone HEIC and HEIF photos to JPEG or PNG right in the browser for free. No upload to any server â€” complete privacy. Free HEIC converter.',
    ...
    steps: [
      ...
      'Download the converted image â€” compatible with Windows, Android, and all non-Apple devices.',
    ],
    faqs: [
  ...
  '/bg-remover': {
    title: 'Background Remover Online Free â€“ Remove Image Background with AI | Arkaserve Tools',
    desc: 'Remove backgrounds from product photos, portraits, and logos using AI online for free. Download as transparent PNG. No signup, no watermark â€” instant background removal on mobile and desktop.',
    ...
    steps: [
      ...
      'Download the transparent PNG image â€” perfect for e-commerce, presentations, or graphic design.',
    ],
    faqs: [
      ...
      { q: 'Can I use this for e-commerce product photos?', a: 'Yes. Background removal is one of the most common uses â€” clean white or transparent backgrounds are required by most e-commerce platforms like Amazon, Flipkart, and Shopify.' },
    ],
  },
  '/color-converter': {
    title: 'Color Converter Online Free â€“ HEX, RGB, HSL, HSV, CMYK | Arkaserve Tools',
    ...
    steps: [
      'Enter a color value in any format â€” HEX code (#ff6b35), RGB values, HSL, HSV, or CMYK.',
    ...
    faqs: [
      ...
      { q: 'Can I use this for CSS color values?', a: 'Yes. CSS supports HEX (#rrggbb), RGB (rgb()), RGBA (rgba()), HSL (hsl()), and HSLA (hsla()) â€” all available from this converter.' },
    ],
  },
  '/word-compare': {
    title: 'Text Diff Tool Online Free â€“ Compare Two Texts Side by Side | Arkaserve Tools',
    ...
    steps: [
      ...
      'Click "Compare" â€” additions are highlighted in green, deletions in red, and unchanged text in white.',
    ...
    faqs: [
      ...
      { q: 'What types of content can I compare?', a: 'Any plain text â€” documents, essays, contracts, code, emails, JSON, CSV, or any other text-based content.' },
  ...
  '/word-count': {
    title: 'Word Count Tool Online Free â€“ Count Words, Characters & More | Arkaserve Tools',
    ...
    steps: [
      ...
      'Review the full text statistics in the results panel â€” no click or button press needed.',
    ],
    faqs: [
      ...
      { q: 'How is reading time calculated?', a: 'Reading time is estimated at 200â€“250 words per minute, which is the average adult reading speed. Adjust for your specific audience.' },
  ...
  '/code-diff': {
    title: 'Code Diff Viewer Online Free â€“ Compare Code Changes | Arkaserve Tools',
    ...
    steps: [
      ...
      'Scroll through both panels side by side to review exactly what changed â€” great for code reviews.',
    ],
    faqs: [
      { q: 'Is the code diff viewer free?', a: 'Yes, 100% free with no signup.' },
      { q: 'Which programming languages are supported?', a: 'Any programming language or plain text works â€” Python, JavaScript, Java, C++, HTML, CSS, SQL, YAML, JSON, and more.' },
  ...
  '/css-js-minifier': {
    title: 'CSS & JS Minifier Online Free â€“ Minify CSS and JavaScript | Arkaserve Tools',
    ...
    steps: [
      ...
      'Select the operation: Minify (for production â€” removes whitespace, comments, and shortens names) or Beautify (for readability).',
      'Copy the output from the result panel â€” the minified code is ready to deploy.',
    ],
    faqs: [
      ...
      { q: 'How much file size reduction can I expect?', a: 'Typical CSS files reduce by 20â€“40% and JavaScript files by 30â€“60% after minification. Code with many comments compresses even more.' },
  ...
  '/markdown-preview': {
    title: 'Markdown Preview & Editor Online Free â€“ Live Markdown Renderer | Arkaserve Tools',
  ...
  '/unit-converter': {
    title: 'Unit Converter Online Free â€“ Length, Weight, Temperature & More | Arkaserve Tools',
    ...
    steps: [
      ...
      'Select the target unit and the converted value appears instantly â€” copy it or try another conversion.',
    ],
    faqs: [
      { q: 'Is the unit converter free?', a: 'Yes, 100% free with no signup.' },
      { q: 'What unit categories are available?', a: 'Length (m, km, miles, feet, inches), Weight (kg, lbs, grams, oz), Temperature (Â°C, Â°F, K), Area, Volume, Speed (km/h, mph, m/s), and Data storage (KB, MB, GB, TB).' },
  ...
  '/timezone-converter': {
    title: 'Timezone Converter Online Free â€“ World Time Zone Clock | Arkaserve Tools',
    ...
    steps: [
      ...
      'Enter the time â€” the equivalent time in the target timezone is shown instantly with the analog clock display.',
    ],
    faqs: [
  ...
  '/base64': {
    title: 'Base64 Encoder & Decoder Online Free | Arkaserve Tools',
    ...
    steps: [
      ...
      'The output appears instantly in the result panel â€” copy it to your clipboard with one click.',
    ],
    faqs: [
      ...
      { q: 'Can I encode image files to Base64?', a: 'Yes. Binary file encoding is supported â€” paste the file\'s binary as hex or use the file upload option to get the Base64 data URI for images.' },
  ...
  '/url-encode': {
    title: 'URL Encoder & Decoder Online Free â€“ Percent Encode URLs | Arkaserve Tools',
    ...
    steps: [
      ...
      'The encoded/decoded result appears instantly â€” copy it and use it in your application or browser.',
    ],
    faqs: [
      { q: 'Is the URL encoder free?', a: 'Yes, completely free with no signup.' },
      { q: 'What is URL encoding?', a: 'URL encoding (percent-encoding) converts characters that are not allowed in URLs â€” like spaces, &, =, +, # â€” into a percent followed by their hex code (e.g., space becomes %20).' },
      ...
      { q: 'What is the difference between encodeURI and encodeURIComponent?', a: 'encodeURI encodes a complete URL (preserving ://?#&=). encodeURIComponent encodes a URL component (query param value) â€” it encodes everything including & and =. Use the appropriate mode on this tool.' },
    ],
  },
  '/favicon-generator': {
    title: 'Favicon Generator Online Free â€“ Create Favicon from Image | Arkaserve Tools',
    desc: 'Upload a logo, image, or emoji to generate favicon PNG files at 16Ã—16, 32Ã—32, 64Ã—64, and 180Ã—180 px online for free. Download as a ZIP. Free favicon maker.',
    ...
    steps: [
      ...
      'Preview the favicon at different sizes (16Ã—16, 32Ã—32, 64Ã—64, 180Ã—180 px) â€” crop or center as needed.',
    ...
    faqs: [
      ...
      { q: 'What sizes should a favicon be?', a: 'Standard sizes are 16Ã—16 (browser tab), 32Ã—32 (taskbar/bookmark), 64Ã—64 (high DPI), and 180Ã—180 px (Apple touch icon for iOS). This tool generates all of them.' },
  ...
  '/color-palette': {
    title: 'Color Palette Extractor Online Free â€“ Extract Colors from Image | Arkaserve Tools',
    ...
    steps: [
      ...
      'The tool automatically extracts the 5â€“10 most dominant colors from the image using color quantization.',
      'Click any color swatch to copy its HEX, RGB, or HSL value â€” use them in your designs or code.',
    ],
    faqs: [
      { q: 'Is the color palette extractor free?', a: 'Yes, completely free with no signup required.' },
      { q: 'How many colors does it extract?', a: 'The tool extracts the 5â€“10 most dominant and visually distinct colors from your image.' },
  ...
  '/css-gradient': {
    title: 'CSS Gradient Generator Online Free â€“ Create CSS Gradients | Arkaserve Tools',
  ...
  '/svg-converter': {
    title: 'SVG to PNG Converter Online Free â€“ Convert SVG to Image | Arkaserve Tools',
    ...
    steps: [
      ...
      'Set the output resolution (width Ã— height in pixels) â€” the default maintains the SVG\'s aspect ratio.',
  ...
  '/image-cropper': {
    title: 'Image Cropper Online Free â€“ Crop Images to Any Size | Arkaserve Tools',
    ...
    steps: [
      ...
      'Click "Crop & Download" to save the cropped image â€” no signup, completely free.',
    ],
    faqs: [
      ...
      { q: 'Is cropping done in my browser?', a: 'Yes. Cropping happens entirely in your browser â€” your image is never uploaded to any server.' },
      { q: 'What image formats are supported?', a: 'JPG, PNG, WebP, and GIF images are supported for cropping.' },
    ],
  },
  '/image-resizer': {
    title: 'Image Resizer Online Free â€“ Resize Images to Exact Size | Arkaserve Tools',
    desc: 'Resize images to exact pixel dimensions, percentage scale, or preset sizes online for free. Convert format and adjust quality. Free online image resizer â€” no signup.',
    ...
    steps: [
      ...
      'Click "Resize & Download" to save the resized image â€” no signup, completely free.',
    ],
    faqs: [
      ...
      { q: 'What are common image sizes I should use?', a: 'Profile photos: 400Ã—400 px; Blog header: 1200Ã—630 px; Facebook cover: 851Ã—315 px; Instagram square: 1080Ã—1080 px; Twitter/X header: 1500Ã—500 px.' },
  ...
  '/image-metadata': {
    title: 'EXIF Metadata Remover Online Free â€“ Strip Image Metadata | Arkaserve Tools',
    ...
    faqs: [
      ...
      { q: 'Does removing metadata change the image appearance?', a: 'No. Only invisible metadata is removed. The image itself â€” colors, quality, and content â€” remains completely unchanged.' },
    ],
  },
  '/json-to-csv': {
    title: 'JSON to CSV Converter Online Free | Arkaserve Tools',
  ...
  '/yaml-json': {
    title: 'YAML to JSON Converter Free â€“ Convert YAML & JSON Online | Arkaserve Tools',
    ...
    steps: [
      'Select the conversion direction: YAML â†’ JSON or JSON â†’ YAML.',
      'Paste your YAML or JSON content into the input area.',
      'Copy the converted output â€” perfect for Kubernetes manifests, Docker Compose, OpenAPI specs, and more.',
    ],
    faqs: [
  ...
  '/xml-formatter': {
    title: 'XML Formatter Online Free â€“ Format & Validate XML | Arkaserve Tools',
    ...
    steps: [
      'Paste your XML content into the input area â€” raw, minified, or unformatted XML works.',
  ...
  '/html-tools': {
    title: 'HTML Tools Online Free â€“ Encode, Decode & Format HTML | Arkaserve Tools',
    ...
    faqs: [
      ...
      { q: 'When should I strip HTML tags?', a: 'Strip HTML tags when you need to extract plain text from an HTML document â€” useful for text analysis, word counting, or preparing content for plain-text emails.' },
  ...
  '/html-entity': {
    title: 'HTML Entity Encoder & Decoder Online Free | Arkaserve Tools',
    ...
    steps: [
      'Select Encode (text â†’ HTML entities) or Decode (HTML entities â†’ text) mode.',
  ...
  '/cron-descriptor': {
    title: 'Cron Expression Descriptor Online Free â€“ Explain Cron Jobs | Arkaserve Tools',
    ...
    steps: [
      ...
      'Use the visual builder to generate a cron expression without memorizing the syntax â€” click to set fields.',
    ],
    faqs: [
      ...
      { q: 'How do I run a cron job every 5 minutes?', a: 'Use the expression "*/5 * * * *" â€” this runs every 5 minutes of every hour, every day. The descriptor confirms: "Every 5 minutes".' },
    ],
  },
  '/number-base': {
    title: 'Number Base Converter Online Free â€“ Binary, Decimal, Hex | Arkaserve Tools',
    ...
    steps: [
      ...
      'All other base representations update instantly â€” see decimal, binary, octal, and hexadecimal at the same time.',
  ...
  '/unicode-inspector': {
    title: 'Unicode Inspector Online Free â€“ Inspect Unicode Characters | Arkaserve Tools',
    ...
    steps: [
      'Paste any text into the input area â€” normal text, emoji, special characters, or text that looks "weird".',
    ...
    faqs: [
      ...
      { q: 'What is a Unicode code point?', a: 'A Unicode code point is a unique number assigned to every character â€” written as U+XXXX (hex). For example, A is U+0041, the heart emoji â¤ is U+2764.' },
  ...
  '/ip-calculator': {
    title: 'IP Calculator Online Free â€“ Subnet & CIDR Calculator | Arkaserve Tools',
  ...
  '/calendar-converter': {
    title: 'Calendar Date Converter Online Free | Arkaserve Tools',
    ...
    faqs: [
      ...
      { q: 'Why do different cultures use different calendars?', a: 'Different cultures developed calendars based on different astronomical cycles â€” solar (Gregorian, Persian), lunar (Islamic), or lunisolar (Hebrew, Chinese). Religious and historical traditions also play a role.' },
  ...
  '/lorem-ipsum': {
    title: 'Lorem Ipsum Generator Online Free â€“ Placeholder Text | Arkaserve Tools',
    ...
    faqs: [
      ...
      { q: 'Can I generate a specific number of words?', a: 'Yes. Choose "Words" as the unit and enter any number from 1 to 10,000 words. For paragraphs, each paragraph has approximately 75â€“100 words.' },
    ],
  },
  '/lab-code-cleaner': {
    title: 'Lab Code Cleaner Online Free | Arkaserve Tools',
    ...
    faqs: [
      ...
      { q: 'What types of code can I clean?', a: 'Any programming language or script â€” Python, JavaScript, SQL, shell scripts, or experimental snippets work with the cleaner.' },
  ...
  '/heic-converter': {
    title: 'HEIC to JPG Converter Online Free â€“ Convert iPhone Photos Instantly | Arkaserve Tools',
  ...
  '/protect-pdf': {
    title: 'Password Protect PDF Online Free â€“ Lock & Encrypt PDF | Arkaserve Tools',
  ...
  '/pdf-to-jpg': {
    title: 'PDF to JPG Converter Free â€“ Convert PDF to Image Online | Arkaserve Tools',
    desc: 'Convert every PDF page to high-resolution JPG or PNG images online for free. No signup, no watermark, no email. Works on mobile and all browsers â€” instant download.',
  ...
  '/jpg-to-pdf': {
    title: 'JPG to PDF Converter Free â€“ Convert Images to PDF Online | Arkaserve Tools',
    desc: 'Convert JPG, PNG, WebP, or HEIC images to a PDF document online for free. Combine multiple photos into one PDF. No signup, no watermark, no email â€” instant download.',
  ...
  '/about': {
    title: 'About Arkaserve Tools â€“ Free Online PDF & Document Tools by Arkaserve',
    desc: 'Learn about Arkaserve Tools, the free all-in-one document, PDF, and code tools platform by Arkaserve. 60+ tools, no signup required.',
    keywords: 'about Arkaserve Tools, free PDF tools, Arkaserve Tools tools, Arkaserve document tools',
  },
  '/contact': {
    title: 'Contact Arkaserve Tools â€“ Get in Touch | Arkaserve Tools',
    desc: 'Contact the Arkaserve Tools team for support, feedback, or questions about our free online document and PDF tools.',
    keywords: 'contact Arkaserve Tools, Arkaserve Tools support, PDF tools help',
  },
  '/privacy-policy': {
    title: 'Privacy Policy â€“ Arkaserve Tools by Arkaserve',
    desc: 'Read the Arkaserve Tools privacy policy. Learn how we handle your files, cookies, and data on our free online tool platform.',
    keywords: 'Arkaserve Tools privacy policy, Arkaserve privacy, free tools privacy policy',
  },
}
...
export function getPageMeta(pathname) {
  ...
  return { title: `${SITE} â€“ Free Document & Code Tools`, desc: DEFAULT_DESC, keywords: DEFAULT_KEYWORDS, steps: [], faqs: [] }
}
